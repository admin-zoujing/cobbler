...
d-i partman-auto/expert_recipe string fsm :: 8196 100% 8196 linux-swap method{ swap } format{ } $lvmok{ } lv_name{ swap } . 20000 20000 20000 xfs method{ lvm } $lvmok{ } mountpoint{ / } lv_name{ root } format{ } use_filesystem{ } filesystem{ xfs } options/relatime{ relatime } . 20000 20000 20000 xfs method{ lvm } $lvmok{ } mountpoint{ /home } lv_name{ home } format{ } use_filesystem{ } filesystem{ xfs } . -1 -1 -1 xfs method{ lvm }
...
d-i pkgsel/include string ntp ssh wget vim gcc telnet net-tools
